...
INDEX_COLS = ['open', 'high', 'close', 'low', 'volume']
SHARE_TYPE = "share"
INDEX_TYPE = "index"
        ...
        if f.get(ktype) is None:
            ...
            if len(f[ktype]) == 0:
                ...
                if start_date >= end_date:
                    ...
                    _append_data(code, ktype, f, start_date, end_date, stype)
