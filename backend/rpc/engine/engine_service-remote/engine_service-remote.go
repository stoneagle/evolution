...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  Response getItemPoint(AssetType assetType, string ctype, string source, string tag)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  case "getStrategy":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "GetStrategy requires 1 args")
      flag.Usage()
    }
    argvalue0 := flag.Arg(1)
    value0 := argvalue0
    fmt.Print(client.GetStrategy(context.Background(), value0))
    fmt.Print("\n")
    break
  case "getClassify":
    if flag.NArg() - 1 != 4 {
      fmt.Fprintln(os.Stderr, "GetClassify requires 4 args")
      flag.Usage()
    }
    tmp0, err := (strconv.Atoi(flag.Arg(1)))
    if err != nil {
  ...
  case "getItemPoint":
    if flag.NArg() - 1 != 4 {
      fmt.Fprintln(os.Stderr, "GetItemPoint requires 4 args")
      flag.Usage()
    }
    tmp0, err := (strconv.Atoi(flag.Arg(1)))
    if err != nil {
    ...
    argvalue3 := flag.Arg(4)
    value3 := argvalue3
    fmt.Print(client.GetItemPoint(context.Background(), value0, value1, value2, value3))
    fmt.Print("\n")
    break
  case "":
    Usage()
